class AdminUser < ActiveRecord::Base
  ...
  #self.table_name = "admin_users" #this to configure a different table name
  ...
  has_many :sections, :through => :section_edits
  	...
  	#this is to restrict user not to create username with these name
  ...
  # errors not related to a specific attributes
